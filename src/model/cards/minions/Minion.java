...
public class Minion extends Card implements Cloneable {
	...
	public String toString() {
		String x="<html>Name :"+getName()+"<br>Mana :"+getManaCost()+"<br>Rarity :"+getRarity()+"<br>Hp :"+currentHP+"<br>Taunt :"
				+taunt+"<br>Divine :"+divine+"<br> Sleeping:"+sleeping+"<br>Attacked :"+attack+"<html>";
		return x;
	}
